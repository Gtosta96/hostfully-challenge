  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell: 'text-gray-600 rounded-md w-8 font-medium text-[0.8rem]',
        ...
        day: cn(
          ...
          'h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:bg-accent transition-colors'
        ),
        ...
        day_today: 'bg-muted-background text-gray-700 !font-semibold',
        day_outside:
